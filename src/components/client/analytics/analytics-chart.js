			...
			<div className="flex flex-row flex-wrap justify-content-between toolbar">
				...
				<div className="flex flex-row right-btns gap-2">
					<div className="flex flex-row align-items-center swictch-btn">
						...
						<InputSwitch checked={ showRequest } onChange={(e) => converShowRequest(e.target.value)} />
					</div>
			...
			<div className="main-part" style={{borderRadius: "8px"}}>
                ...
                <div className={`${ showRequest ? 'comment-container-request' : 'comment-container'}`}>
                    <div className='flex flex-row align-items-center justify-content-between month-comment'>
                        <div className='flex align-items-center justify-content-center month-btn'><img src={ Left_Icon }/></div>
                        <div className='flex flex-wrap align-items-center justify-content-between' style={{width:'80%'}}>
                            <span >August</span>
                            <span >September</span>
                            <span >October</span>
                        </div>
                        <div className='flex align-items-center justify-content-center month-btn'><img src={ Right_Icon }/></div>
                    </div>
                    <div className='flex align-items-center justify-content-between'>
                            <span className='date-comment'>1</span><span className='date-comment'>8</span><span className='date-comment'>16</span><span className='date-comment'>24</span><span className='date-comment'>31</span>
                            <span className='date-comment'>1</span><span className='date-comment'>7</span><span className='date-comment'>14</span><span className='date-comment'>24</span><span className='date-comment'>31</span>
                            <span className='date-comment'>7</span><span className='date-comment'>14</span><span className='date-comment'>24</span><span className='date-comment'>31</span>
                    </div>
                    <div className='flex flex-row grid-part'>
                        ...
                        {
                            showRequest ? <div className='quest-diagram-container'>
                                    {
                                        Diagrams.map((item, index) => (
                                            <div key={index} style={{bottom:`${item.bottom}%`,left:`${item.start}%`, width:`${item.width}px`}} className='flex flex-row align-items-center quest-diagram'>
                                                <img src={ Circle_Icon } className='mr-1'/>{ item.title }
                                            </div>
                                        ))
                                    }
                    ...
                    <div className='flex align-items-center justify-content-center'>
                        <div className='flex flex-wrap align-items-center justify-content-between gap-3' >
                            <div className="flex align-items-center justify-content-center chk-box-discord">
                                <Checkbox inputId="ingredient1" name="discord" value="Discord" onChange={ showDiscord } checked={ discordShow } 
                                    className='chk-show-box'/>
                                <label htmlFor="ingredient1" className="ml-2 chk-show-comment">Discord</label>
                            </div>
                            <div className="flex align-items-center justify-content-center chk-box-twitter">
                                <Checkbox inputId="ingredient2" name="twitter" value="Twitter" onChange={ showTwitter } checked={ twitterShow } 
                                    className='chk-show-box'/>
                                <label htmlFor="ingredient2" className="ml-2 chk-show-comment">Twitter</label>
                            </div>
                            <div className="flex align-items-center justify-content-center chk-box-marko">
                                <Checkbox inputId="ingredient3" name="marko" value="Marko" onChange={ showMarko } checked={ markoShow } 
                                    className='chk-show-box'/>
                                <label htmlFor="ingredient3" className="ml-2 chk-show-comment">Marko</label>
                            </div>
                        </div>
                    </div>
                </div>
