...
const Analytics = () => {
	...
	let discord = [68, 69, 70, 71, 70, 72, 73, 74, 75, 74, 73, 76, 75,75];
	let twitter = [38, 39, 40, 41, 40, 43, 44,44, 45, 43, 47, 46, 44,43];
	let marko =  [28, 29, 30, 31, 30, 32, 33,34, 35, 36, 37, 36, 35,35];
	let diagrams = [
	...
	return (
		<div >
			...
			<div className='analytics-doughnut'>
				<div className='flex flex-wrap align-items-center justify-content-between toolbar'>
					...
					<div className='flex align-items-center  gap-2'>
						<div className='btn'>7 d</div>
						<div className='btn'>15 d</div>
						<div className='btn'>30 d</div>
						<div className='btn'>60 d</div>
						<div className='btn'>90 d</div>
					</div>
				</div>
				<div className='flex flex-wrap flex-row align-items-center justify-content-between gap-4'>
					<div  className="flex-grow-1"> <Doughnut title="Twitter" percentage={75} left_num={'400k'} right_num={'1,5m'}/></div>
					<div  className="flex-grow-1"><Doughnut title="Discord" percentage={60} left_num={'400k'} right_num={'1m'}/></div>
					<div  className="flex-grow-1"><Doughnut title="Telegram" percentage={75} left_num={'400k'} right_num={'1m'}/></div>
				</div>
			</div>
			<AnalyticsTable/>
		</div>
